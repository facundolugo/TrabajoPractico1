...
#Importación de librerías: Utiliza NLTK para procesamiento de texto, matplotlib para gráficos y TfidfVectorizer de Scikit-learn para análisis de texto.

#Descarga de recursos: Se descargan recursos como el tokenizador y el lematizador para preparar el texto.

#Preparación del corpus: Limpia el texto, eliminando palabras irrelevantes, convirtiendo las palabras a minúsculas y lematizando las palabras.

#Generación de matriz TF-IDF: Convierte el texto limpio en una matriz numérica que refleja la importancia de cada palabra.

#Análisis de frecuencia de palabras: Cuenta las palabras más frecuentes en el corpus.

#Análisis de una oración específica: Cuenta las repeticiones de palabras en una oración elegida.

#Visualización gráfica: Muestra gráficos de barras, torta y línea sobre la distribución de las palabras más frecuentes.
